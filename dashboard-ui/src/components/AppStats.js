...
export default function AppStats() {
	...
	const getStats = () => {
        ...
        fetch(`http://kafka-ijaz.eastus.cloudapp.azure.com/processing/stats`)
            .then(res => res.json())
            .then((result)=>{
            ...
            <div>
                ...
                <table className={"StatsTable"}>
					<tbody>
						...
						<tr>
							<td># of AR: {stats['num_acceleration_readings']}</td>
							<td># of ER: {stats['num_environmental_readings']}</td>
						</tr>
						<tr>
